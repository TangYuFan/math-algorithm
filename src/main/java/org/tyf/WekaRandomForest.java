...
/**
 *   @desc : weka RandomForest随机森林
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaRandomForest {

    // RandomForest 通过随机森林生成的决策树模型。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\唐于凡\\Desktop\\randomForest.model";
        ...
        randomForest.setClassifier(new RandomTree()); // 设置基础二分类器
        randomForest.setNumIterations(50); // 迭代次数
        randomForest.setPrintClassifiers(true);
        randomForest.setOptions(new String[]{"-I","30"}); // 随机树的个数、更多参数见函数注释
        ...
        evaluation.evaluateModel(randomForest, validationData);
        ...
        // 模型保存
        SerializationHelper.write(module, randomForest);
        RandomForest model = (RandomForest) SerializationHelper.read(module);
