...
/**
 *   @desc : weka NaiveBayesUpdateable可更新的贝叶斯分类器
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaNaiveBayesUpdateable {

    // NaiveBayesUpdateable 可更新贝叶斯分类器，适用于流式数据。
    // 可以不断接收新的样本以更新模型



    // 模型评估
    public static void Eval(NaiveBayesUpdateable nbClassifier,Instances dataValid) throws Exception{
...
//        System.out.println(evaluation.toSummaryString());
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 训练
        NaiveBayesUpdateable nbClassifier = new NaiveBayesUpdateable();
