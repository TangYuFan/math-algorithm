...
/**
 *   @desc : weka LogitBoost 算法， Boosting 算法的变体。
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaLogitBoost {

    // LogitBoost LogitBoost 算法，一种 Boosting 算法的变体。
    ...
    public static void main(String[] args) throws Exception{
        ...
        LogitBoost model = (LogitBoost) SerializationHelper.read(module);
