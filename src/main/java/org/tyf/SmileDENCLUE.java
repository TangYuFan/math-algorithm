...
/**
 *   @desc : Smile DENCLUE 聚类
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileDENCLUE {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\DENCLUE";
        ...
        double sigma = 10.98;
        int m = 3;
        DENCLUE denclue = DENCLUE.fit(trainData.select("f1","f2","f3","f4","f5").toArray(),sigma,m);

        System.out.println("denclue:"+denclue);

        System.out.println("\n模型序列化：");
        Write.object(denclue,new File(module).toPath());
        System.out.println("Write module："+module);
        DENCLUE obj = (DENCLUE)Read.object(new File(module).toPath());
