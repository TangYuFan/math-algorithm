...
/**
 *   @desc : weka HoeffdingTree霍夫丁树分类器
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaHoeffdingTree {

    // HoeffdingTree 是一种增量学习的决策树算法，它可以适应数据流的变化而动态地调整决策树结构。Hoeffding Tree属于Weka中的流式学习算法
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\HoeffdingTree.model";
        ...
        HoeffdingTree model = (HoeffdingTree) SerializationHelper.read(module);
