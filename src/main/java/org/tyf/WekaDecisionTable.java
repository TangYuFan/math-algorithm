...
/**
 *   @desc : weka DecisionTable决策表模型
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaDecisionTable {

    // DecisionTable 决策表模型，通过规则表进行分类。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\WekaDecisionTable.model";
        ...
        DecisionTable model = (DecisionTable) SerializationHelper.read(module);
