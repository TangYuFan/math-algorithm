...
/**
 *   @desc : Smile RDA 正则判别分析
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileRDA {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\RDA";
        ...
        System.out.println("\n模型序列化：");
        Write.object(rda,new File(module).toPath());
        System.out.println("Write module："+module);
        RDA obj = (RDA)Read.object(new File(module).toPath());
