...
/**
 *   @desc : weka VotedPerceptron加权感知器分类器。
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaVotedPerceptron {

    // VotedPerceptron 加权感知器分类器。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\VotedPerceptron.model";
        ...
        VotedPerceptron model = (VotedPerceptron) SerializationHelper.read(module);
