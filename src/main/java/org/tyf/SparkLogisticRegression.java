...
public class SparkLogisticRegression {
    ...
    // spark-submit --master spark://172.16.5.248:7077 --class org.tyf.SparkLogisticRegression /usr/algorithm-v1-jar-with-dependencies.jar
    ...
    public static void main(String[] args) {
        ...
        SparkConf conf = new SparkConf().setAppName("SparkLogisticRegression").setMaster("local[*]");
        ...
        // 逻辑回归
        LogisticRegression r = new LogisticRegression()
                .setLabelCol("label")
