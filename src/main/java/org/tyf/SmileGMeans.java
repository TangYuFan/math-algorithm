...
/**
 *   @desc : Smile GMeans 聚类
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileGMeans {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\gMeans";
        ...
        int k = 5;
        GMeans gMeans = GMeans.fit(trainData.select("f1","f2","f3","f4","f5").toArray(),k);

        System.out.println("gMeans:"+gMeans);

        System.out.println("\n模型序列化：");
        Write.object(gMeans,new File(module).toPath());
        System.out.println("Write module："+module);
        GMeans obj = (GMeans)Read.object(new File(module).toPath());
