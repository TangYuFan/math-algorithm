...
/**
 *   @desc : weka MultiClassClassifier多类别分类器
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaMultiClassClassifier {

    // MultiClassClassifier 多类别分类器，可将多个二进制分类器组合成一个多类别分类器。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\唐于凡\\Desktop\\classifier.model";
        ...
        classifier.setClassifier(new J48()); // 设置基础二分类器
        ...
        MultiClassClassifier model = (MultiClassClassifier) SerializationHelper.read(module);
