...
/**
 *   @desc : Smile RandomForestReg 随机森林回归
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileRandomForestReg {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\RandomForest";
...
//        System.out.println(df.summary());
        ...
        RandomForest fit = RandomForest.fit(fm,trainData,params);



        // 模型评估 - 准确率
        double[] truth = valiaData.doubleVector("score").toDoubleArray(); // 真实值
        double[] predit = fit.predict(valiaData);
        ...
        RandomForest obj = (RandomForest)Read.object(new File(module).toPath());
