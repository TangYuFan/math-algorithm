...
/**
 *   @desc : weka SimpleLogistic逻辑回归分类
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaSimpleLogistic {

    // SimpleLogistic 简单逻辑回归算法，用于分类问题。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\simpleLogistic.model";
        ...
        // 创建线性回归模型
        SimpleLogistic linearRegression = new SimpleLogistic();
        ...
        SimpleLogistic model = (SimpleLogistic) SerializationHelper.read(module);
