...
/**
 *   @desc : Smile DeterministicAnnealing 确定性退火聚类
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileDeterministicAnnealing {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\DeterministicAnnealing";
        ...
        int k = 3;
        DeterministicAnnealing annealing = DeterministicAnnealing.fit(trainData.select("f1","f2","f3","f4","f5").toArray(),k);

        System.out.println("DeterministicAnnealing:"+annealing);

        System.out.println("\n模型序列化：");
        Write.object(annealing,new File(module).toPath());
        System.out.println("Write module："+module);
        DeterministicAnnealing obj = (DeterministicAnnealing)Read.object(new File(module).toPath());
