...
/**
 *   @desc : weka AttributeSelectedClassifier使用特征选择的分类器
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaAttributeSelectedClassifier {

    // AttributeSelectedClassifier 使用特征选择的分类器。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\WekaAttributeSelectedClassifier.model";
...
//        classifier.setClassifier(new SMO());// 基本分类器
        classifier.setClassifier(new J48());// 基本分类器
        classifier.setEvaluator(new CfsSubsetEval()); // 特征选择算法
        classifier.setSearch(new BestFirst());

        System.out.println("classifier:"+classifier.getClassifier());
        System.out.println("getEvaluator:"+classifier.getEvaluator());
        System.out.println("getSearch:"+classifier.getSearch());
        ...
        AttributeSelectedClassifier model = (AttributeSelectedClassifier) SerializationHelper.read(module);
