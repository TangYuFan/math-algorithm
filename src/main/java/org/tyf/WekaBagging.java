...
/**
 *   @desc : weka BaggingBagging集成学习
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaBagging {

    // Bagging Bagging 算法，通过对数据集进行有放回的随机采样训练多个模型。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\唐于凡\\Desktop\\bagging.model";
        ...
        bagging.setClassifier(new J48()); // 设置基础二分类器
        bagging.setNumIterations(50); // 迭代次数

        // 训练
        bagging.buildClassifier(trainingData);

        Evaluation evaluation = new Evaluation(validationData);
        evaluation.evaluateModel(bagging, validationData);
        ...
        // 模型保存
        SerializationHelper.write(module, bagging);
        Bagging model = (Bagging) SerializationHelper.read(module);
