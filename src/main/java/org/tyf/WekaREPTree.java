...
/**
 *   @desc : weka REPTreeREPTree决策树
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaREPTree {

    // REPTree REPTree（REgression tree）是Weka的一个实现，它使用递归二分划分的方式构建决策树，并适用于回归任务，可以预测数值型的目标变量。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\WekaREPTree.model";
        ...
        // 模型保存
        SerializationHelper.write(module, repTree);
        REPTree model = (REPTree) SerializationHelper.read(module);
