...
/**
 *   @desc : weka NativeBayes朴素贝叶斯分类器
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaNativeBayes {

    // NativeBayes 朴素贝叶斯分类器，基于属性的条件独立性假设。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\唐于凡\\Desktop\\bayes.model";
        ...
        evaluation.evaluateModel(naiveBayes, validationData);
        ...
        // 模型保存
        SerializationHelper.write(module, naiveBayes);
        NaiveBayes model = (NaiveBayes) SerializationHelper.read(module);
