...
/**
 *   @desc : Smile FLD Fisher判别分析
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileFLD {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\FLD";
        ...
        System.out.println("\n模型序列化：");
        Write.object(fld,new File(module).toPath());
        System.out.println("Write module："+module);
        FLD obj = (FLD)Read.object(new File(module).toPath());
