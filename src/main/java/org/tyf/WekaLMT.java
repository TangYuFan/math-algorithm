...
/**
 *   @desc : weka LMTLMT树分类器
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaLMT {

    // LMT Model Trees的思想，这是一种结合了线性模型和树模型的方法
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\LMT.model";
        ...
        LMT model = (LMT) SerializationHelper.read(module);
