...
/**
 *   @desc : Smile RBFNetworkReg RBF网络回归
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileRBFNetworkReg {
    ...
    public static void main(String[] args) throws Exception{
        ...
        params.setProperty("smile.rbf.neurons", "30");
        params.setProperty("smile.rbf.normalize", "false");

        RBFNetwork fit = RBFNetwork.fit(
                trainData.select("f1","f2","f3","f4").toArray(),
                trainData.doubleVector("score").toDoubleArray(),
                params);
        ...
        RBFNetwork obj = (RBFNetwork)Read.object(new File(module).toPath());
