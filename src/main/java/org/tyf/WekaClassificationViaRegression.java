...
/**
 *   @desc : weka ClassificationViaRegression通过回归进行分类
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaClassificationViaRegression {

    // ClassificationViaRegression 通过回归进行分类.它通过将分类任务转化为回归任务来处理
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\WekaClassificationViaRegression.model";
        ...
        classifier.setClassifier(new LinearRegression()); // 设置基础回归算法
        ...
        ClassificationViaRegression model = (ClassificationViaRegression) SerializationHelper.read(module);
