...
/**
 *   @desc : Smile QDA 二次判别分析
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileQDA {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\QDA";
        ...
        System.out.println("\n模型序列化：");
        Write.object(qda,new File(module).toPath());
        System.out.println("Write module："+module);
        QDA obj = (QDA)Read.object(new File(module).toPath());
