...
public class SmileLDA {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\LDA";
        ...
        System.out.println("\n模型序列化：");
        Write.object(lda,new File(module).toPath());
        System.out.println("Write module："+module);
        LDA obj = (LDA)Read.object(new File(module).toPath());
