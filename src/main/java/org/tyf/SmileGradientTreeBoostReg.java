...
/**
 *   @desc : Smile GradientTreeBoostReg 梯度提升树回归
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileGradientTreeBoostReg {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\GradientTreeBoost";
...
//        System.out.println(df.summary());
        ...
        params.setProperty("smile.ridge.lambda", "1");

        GradientTreeBoost tree = GradientTreeBoost.fit(fm,trainData,params);



        // 模型评估 - 准确率
        double[] truth = valiaData.doubleVector("score").toDoubleArray(); // 真实值
        double[] predit = tree.predict(valiaData);
        ...
        System.out.println("\n模型序列化：");
        Write.object(tree,new File(module).toPath());
        System.out.println("Write module："+module);
        GradientTreeBoost obj = (GradientTreeBoost)Read.object(new File(module).toPath());
