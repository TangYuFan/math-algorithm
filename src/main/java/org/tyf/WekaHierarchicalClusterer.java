...
/**
 *   @desc : weka HierarchicalClusterer层次聚类
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaHierarchicalClusterer {

    // HierarchicalClusterer 层次聚类算法，通过构建聚类层次树进行聚类。
    ...
    public static void visualizeClusters(Instances data, HierarchicalClusterer clusterer) throws Exception {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\WekaHierarchicalClusterer.model";
