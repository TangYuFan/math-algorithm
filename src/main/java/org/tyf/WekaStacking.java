...
/**
 *   @desc : weka Stacking堆叠多个分类器进行学习
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaStacking {

    // Stacking Stacking 算法，通过堆叠多个分类器进行学习。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\Stacking.model";
        ...
        Stacking classifier = new Stacking();

        // 设置基本分类器
        classifier.setClassifiers(new Classifier[]{new J48(),new SMO()});

        // 设置元分类
        classifier.setMetaClassifier(new J48());
        ...
        Stacking model = (Stacking) SerializationHelper.read(module);
