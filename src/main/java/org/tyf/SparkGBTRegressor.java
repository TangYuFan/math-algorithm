 ...
 */
public class SparkGBTRegressor {
    ...
    // spark-submit --master spark://172.16.5.248:7077 --class org.tyf.SparkGBTRegressor /usr/algorithm-v1-jar-with-dependencies.jar
    ...
    public static void main(String[] args) {
        ...
        SparkConf conf = new SparkConf().setAppName("SparkGBTRegressor").setMaster("local[*]");
