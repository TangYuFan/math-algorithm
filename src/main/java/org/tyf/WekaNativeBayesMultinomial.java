...
/**
 *   @desc : weka NativeBayesMultinomial多项式朴素贝叶斯分类器
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaNativeBayesMultinomial {

    // NativeBayesMultinomial 多项式朴素贝叶斯分类器，适用于多项离散数据。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\NaiveBayesMultinomial.model";
        ...
        NaiveBayesMultinomial model = (NaiveBayesMultinomial) SerializationHelper.read(module);
