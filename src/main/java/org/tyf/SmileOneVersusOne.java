...
/**
 *   @desc : Smile OneVersusOne 1v1分类器
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileOneVersusOne {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\OneVersusOne";
        ...
        DataFrameClassifier oneVersusRest = OneVersusOne.fit(
                formula,
                trainData,
