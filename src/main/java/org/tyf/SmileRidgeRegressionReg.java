...
/**
 *   @desc : Smile RidgeRegressionReg 岭回归
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileRidgeRegressionReg {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\RidgeRegression";
...
//        System.out.println(df.summary());
        ...
        LinearModel ols = RidgeRegression.fit(fm,trainData,params);
