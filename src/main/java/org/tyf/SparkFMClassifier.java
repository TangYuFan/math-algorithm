 ...
 */
public class SparkFMClassifier {
    ...
    // spark-submit --master spark://172.16.5.248:7077 --class org.tyf.SparkFMClassifier /usr/algorithm-v1-jar-with-dependencies.jar
    ...
    public static void main(String[] args) {
        ...
        SparkConf conf = new SparkConf().setAppName("SparkFMClassifier").setMaster("local[*]");
