...
/**
 *   @desc : weka AdaBoostM1AdaBoost变体
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaAdaBoostM1 {

    // AdaBoostM1 AdaBoost 算法的一种变体，使用多个弱分类器来构建强分类器。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\唐于凡\\Desktop\\adaBoostM1.model";
        ...
        adaBoostM1.setClassifier(new J48()); // 设置基础二分类器
        adaBoostM1.setNumIterations(50); // 迭代次数

        // 训练
        adaBoostM1.buildClassifier(trainingData);

        Evaluation evaluation = new Evaluation(validationData);
        evaluation.evaluateModel(adaBoostM1, validationData);
        ...
        // 模型保存
        SerializationHelper.write(module, adaBoostM1);
        AdaBoostM1 model = (AdaBoostM1) SerializationHelper.read(module);
