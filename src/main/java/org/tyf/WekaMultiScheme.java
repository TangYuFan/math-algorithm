...
/**
 *   @desc : weka MultiScheme使用多个分类器。
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaMultiScheme {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\MultiScheme.model";
        ...
        MultiScheme classifier = new MultiScheme();
        classifier.setClassifiers(new Classifier[]{new J48(),new J48(),new J48()}); // 设置子分类器
        ...
        MultiScheme model = (MultiScheme) SerializationHelper.read(module);
