...
public class WekaIBk {
    ...
    public static void generateCsv(String csv){
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(csv, true))) {
            for (int i = 0; i < 10000; i++) {
                ...
                String label = "";
                double score = f1*10 + f2*5 + f3*5 - f4*5 + r.nextInt(200);
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\IBk.model";
        ...
        IBk model = (IBk) SerializationHelper.read(module);
