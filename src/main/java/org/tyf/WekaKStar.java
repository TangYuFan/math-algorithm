...
/**
 *   @desc : weka KStarKStar算法。
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaKStar {

    // KStar KStar 算法，实现 k-近邻算法。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\KStar.model";
        ...
        // 模型保存
        SerializationHelper.write(module, logistic);
        KStar model = (KStar) SerializationHelper.read(module);
