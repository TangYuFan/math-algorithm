...
/**
 *   @desc : weka RandomTree随机特征选择生成的决策树
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaRandomTree {

    // RandomTree 使用随机特征选择生成的决策树。
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\WekaRandomTree.model";
...
//        tree.setOptions(new String[]{});
        ...
        RandomTree model = (RandomTree) SerializationHelper.read(module);
