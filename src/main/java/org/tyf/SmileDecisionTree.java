...
/**
 *   @desc : Smile DecisionTree 决策树
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileDecisionTree {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\SmileDecisionTree";
        ...
        DecisionTree tree = DecisionTree.fit(formula,trainData);

        // 模型评估
        int[] truthIndex = valiaData.intVector("labelIndex").stream().toArray(); // 样本 label 索引
        int[] prediIndex = tree.predict(valiaData); // 预测 label 索引
        ...
        DecisionTree obj = (DecisionTree)Read.object(new File(module).toPath());
