...
/**
 *   @desc : weka SMOreg序列最小优化算法支持向量机 回归任务
 *   @auth : tyf
 *   @date : 2022-03-04  17:17:22
*/
public class WekaSMOreg {

    // SMOreg 序列最小优化算法，用于支持向量机回归。
    ...
    private static void visualizeRegressionResult(SMOreg reg, Instances data) throws Exception {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型保存和加载路径
        String module = "C:\\Users\\tyf\\Desktop\\SMOreg.model";
        ...
        SMOreg model = (SMOreg) SerializationHelper.read(module);
        // 使用模型进行单个样本预测
        for (int i = 0; i < 30; i++) {
        ...
        // 可视化
        visualizeRegressionResult(reg,validationData);
