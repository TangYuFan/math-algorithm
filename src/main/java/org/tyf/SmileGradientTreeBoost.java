...
/**
 *   @desc : Smile GradientTreeBoost 梯度提升
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileGradientTreeBoost {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\唐于凡\\Desktop\\SmileGradientTreeBoost";
        ...
        // 模型
        GradientTreeBoost model = GradientTreeBoost.fit(formula, trainData, 100, 5, 100, 1, 0.1, 1.0);
