...
/**
 *   @desc : Smile RegressionTreeReg 回归树
 *   @auth : tyf
 *   @date : 2022-03-08  16:38:14
*/
public class SmileRegressionTreeReg {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 模型路径
        String module = "C:\\Users\\tyf\\Desktop\\RegressionTree";
...
//        System.out.println(df.summary());
        ...
        RegressionTree tree = RegressionTree.fit(fm,trainData,params);
        ...
        RegressionTree obj = (RegressionTree)Read.object(new File(module).toPath());
